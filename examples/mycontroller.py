...
class TopoGraph:
    ...
    def add_link(self, link):
        for link_str in link:
            if str(link[link_str]) != '{}':
                link_node = link[link_str]
                print(link_node)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--p4info', help='p4info proto in text format from p4c',
                        ...
                        default='./substitution/exercises/p4runtime/build/basic.p4.p4info.txt')
    parser.add_argument('--bmv2-json', help='BMv2 JSON file from p4c',
                        type=str, action="store", required=False,
                        default='./substitution/exercises/p4runtime/build/basic.json')
    parser.add_argument('--topo-json', help='topology.json file',
                        type=str, action="store", required=False,
                        default='./p4/luke-topology.mn')
